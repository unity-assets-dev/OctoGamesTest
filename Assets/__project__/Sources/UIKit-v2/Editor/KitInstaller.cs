...
public class KitInstaller {
    ...
    private class SceneConstructor {
        ...
        private void AddCommons(Scene scene) {
            ...
            CreateComponent<Camera>("Camera").transform.SetParent(commons.transform);
            CreateComponent<Light>("Light").transform.SetParent(commons.transform);
            ...
            T CreateComponent<T>(string name) where T : Component {
                var result = Object.FindAnyObjectByType<T>();
